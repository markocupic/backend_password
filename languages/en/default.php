...
if (TL_MODE == 'BE')
{
	$GLOBALS['TL_LANG']['ERR']['invalidLogin']		= 'Login failed! <a href="contao/pwrecovery.php?username=' . $this->Input->post('username') . '">Password lost?</a>';
	$GLOBALS['TL_LANG']['ERR']['accountLocked']		= 'This account has been locked! You can log in again in %d minutes. <a href="contao/pwrecovery.php?username=' . $this->Input->post('username') . '">Password lost?</a>';
}
...
$GLOBALS['TL_LANG']['MSC']['pwrecoveryMessage']	= "Your password at %s for user %s has been reset.\n\nYour new password is: %s";
